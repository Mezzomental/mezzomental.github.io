...
public class PaintEstimator {
   public static void main(String[] args) {
	  ...
	  // Prompt user to enter wall's height	
	  ...
	  //validate the input
	  if (wallHeight < 0.0 && wallWidth < 0.0){
		  ...
		  cansNeeded = (int)gallonsPaintNeeded / (int)gallonsPerCan;  //Hint: this line is missing two operations
